"""MPFTM algorithm implementation"""
import sys
import os
...
class MPFTM:
    ...
    def mpftm_run(self):
        ...
        sum_migration_cost += evaluation.calculate_migration_cost(
            self.arc_graph, migration_records) * 0.68
        sum_execute_cost += evaluation.calculate_execute_tasks_cost(self.agents) * 0.8
        survival_rate += evaluation.calculate_mean_survival_rate(self.agents) * 0.95
