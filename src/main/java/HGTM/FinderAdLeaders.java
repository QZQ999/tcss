...
public class FinderAdLeaders {
    public List<Agent> findAdLeaders(Group group, HashMap<Integer, Agent> idToRobots, HashMap<Integer, Group> idToGroups,
        ...
        PriorityQueue<Agent> adLeadersPq= new PriorityQueue<>((o1, o2)->
