...
public class CalculatePonField {
    ...
    public CalculatePonField(HashMap<Integer, Group> idToGroups, HashMap<Integer, Agent> idToRobots, DefaultUndirectedWeightedGraph<Integer, DefaultWeightedEdge> arcGraph,
