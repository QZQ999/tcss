...
public class Evalution {
    ...
    public Evalution(HashMap<Integer, Agent> idToRobots, HashMap<Integer, Group> idToGroups) {
    ...
    //计算完成任务的成本
    public Double calculateExecuteTasksCost(List<Agent> robots) {
        Double sum = 0.0;
    ...
    //计算平均存活率
    public Double calculateMeanSurvivalRate(List<Agent> robots) {
        Double sum = 0.0;
        int count = 0;
        for (Agent robot : robots) {
